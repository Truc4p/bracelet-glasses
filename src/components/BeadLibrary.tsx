...
import { CRYSTAL_LIBRARY, SPACERS, ZODIAC_CHARMS, ZODIAC_ANIMALS, type CrystalBead, type Spacer, type ZodiacCharm } from "@/lib/luxe-data";

type TabType = 'crystals' | 'spacers' | 'charms';
...
const BeadLibrary = ({ onSelectBead, onSelectSpacer, onSelectCharm, open, onClose }: BeadLibraryProps) => {
  ...
  return (
    <div className="absolute left-0 top-0 bottom-0 w-72 glass-panel rounded-lg z-20 flex flex-col animate-slide-in">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-1">
        {activeTab === 'crystals' && filteredCrystals.map((bead) => (
          <button
            key={bead.id}
